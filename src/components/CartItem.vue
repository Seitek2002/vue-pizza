<template>
  <div class="cart__item">
    ...
    <div class="cart__item-count">
      ...
      <b v-if="pizza.count">{{ pizza.count }}</b>
    ...
    <div @click="handleDelete" class="cart__item-remove">
...
export default {
  ...
  setup(props) {
    ...
    const handleDecrementPizza = () => {
      store.commit("DECREMENT_ITEM_PIZZA", props.pizza);
    };

    const handleIncrementPizza = () => {
      store.commit("INCREMENT_ITEM_PIZZA", props.pizza);
    };

    return {
      store,
      handleDelete,
      handleDecrementPizza,
      pizzaTotalPrice,
      handleIncrementPizza
    };
  },
};
</script>
